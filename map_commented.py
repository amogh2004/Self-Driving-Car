...
# Importing the Dqn(Deep Q Network) object from our AI in ia.py
from ai import Dqn
...
class Car(Widget):
    ...
    def move(self, rotation):
        ...
        # getting the signal received by sensor 1 (density of sand around sensor 1) 400=20*20
        ...
        # MAKING SURE THAT THE CAR IS NOT IN ANY OF THE EDGES OF THE GAME WINDOW
